...
(defun lcz-set-font (latin-size &optional chinese-size)
...
(defun lcz-fontset-monaco (&optional size)
  (interactive "P")
  (setq my-latin-font "Monaco")
...
(defun lcz-fontset-lucida (&optional size)
  (interactive "P")
...
(defun lcz-fontset-courier (&optional size)
  (interactive "P")
...
(defun lcz-fontset-dejavu (&optional size)
  (interactive "P")
...
(defun lcz-fontset-fixedsys (&optional size)
  (interactive "P")
  ...
  (lcz-set-font my-latin-size my-chinese-size))

(defun lcz-fontset-consolas (&optional size)
  (interactive "P")
